...
class DepositMoneyTests {
    ...
    public DepositMoneyTests() {
        final BankAccountRepositoryFake accountRepository = new BankAccountRepositoryFake();

        this.depositMoney = new DepositMoney(new TransactionRepositoryFake(),
                accountRepository,
    ...
    void deposit_money_successfully() {
        ...
        assertThatNoException().isThrownBy(()-> {
            final TransactionReceipt transactionReceipt = depositMoney.deposit(depositRequest);
    ...
    void can_not_deposit_money_to_non_existed_bank_account() {
        ...
        assertThatExceptionOfType(CouldNotFindBankAccount.class).isThrownBy(()-> depositMoney
    ...
    void cannot_deposit_money_to_disable_bank_account() {
        ...
        assertThatExceptionOfType(CouldNotProcessTransaction.class)
                .isThrownBy(()-> depositMoney.deposit(depositRequest));
    }
}
